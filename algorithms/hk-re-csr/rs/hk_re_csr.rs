...
struct BipartiteGraph {
    ...
    t_num_vtxs: usize,
    num_edgs: usize,
    s_idx: Vec<usize>,    // length s_num_vtxs+1
    t_idx: Vec<usize>,    // length t_num_vtxs+1
    s_adj: Vec<i32>,      // length num_edgs: t-vertex IDs, indexed by s_idx
    t_adj: Vec<i32>,      // length num_edgs: s-vertex IDs, indexed by t_idx
}
...
fn main() {
    println!("Hopcroft-Karp Algorithm - Rust Implementation (CSR)");
    println!("=====================================================\n");
