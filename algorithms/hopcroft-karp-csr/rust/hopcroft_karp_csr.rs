...
impl HopcroftKarp {
    fn new(left_count: usize, right_count: usize, edges: &[(usize, usize)]) -> Self {
        ...
        for i in 0..left_count {
            adj_edges.extend_from_slice(&tmp[i]);
        }
...
/* Validation: check each matched edge exists in the CSR adjacency */
...
fn main() {
    println!("Hopcroft-Karp CSR Algorithm - Rust Implementation");
    println!("====================================================\n");
