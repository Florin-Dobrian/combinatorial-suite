"""
Edmonds' Blossom Algorithm (Optimized) – Unweighted Maximum Cardinality Matching
    ...
    def solve(self, greedy_mode=0):
        ...
        while True:
            ...
            for v in range(self.n):
                if self.mate[v] == NIL and self.label[self.inblossom[v]] == 0:
                    self.assign_label(v, 1, NIL)
                ...
                for w in self.adj[v]:
                    ...
                    if self.label[bw] == 0:
                        ...
                        if base >= 0:
                            ...
                            # base == -2: two different trees met -> augmenting path
            ...
            if not augmented:
                break  # no augmenting path found: matching is maximum
